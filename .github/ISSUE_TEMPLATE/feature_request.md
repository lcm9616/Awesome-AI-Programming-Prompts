...
<!-- 用1-2句话清晰简洁地描述你希望添加的功能 -->
<!-- Describe the feature you want to add clearly and concisely in 1-2 sentences -->
...
<!-- 描述这个功能要解决的问题或改进的场景 -->
<!-- Describe the problem this feature solves or the scenario it improves -->
...
<!-- 详细描述你希望如何实现这个功能 -->
<!-- Describe in detail how you want this feature to be implemented -->

### 📝 针对提示词的改进 | Prompt-specific Improvements

<details>
<summary>🔧 现有提示词改进 | Existing Prompt Improvement</summary>

**目标提示词 | Target Prompt**: `[提示词名称/Prompt name]`

**建议修改的部分 | Suggested Modifications**:
- [ ] 🎭 Role - 角色定义 | Role definition
- [ ] 📖 Background - 背景描述 | Background description
- [ ] ⚠️ Attention - 注意事项 | Attention points
- [ ] 👤 Profile - 详细档案 | Detailed profile
- [ ] 🎯 Goals - 目标设定 | Goal setting
- [ ] 🚫 Constrains - 约束条件 | Constraints
- [ ] 🔄 Workflow - 工作流程 | Workflow
- [ ] 📄 OutputFormat - 输出格式 | Output format
- [ ] 💡 Suggestions - 建议事项 | Suggestions
- [ ] 🚀 Initialization - 初始化 | Initialization

**具体改进内容 | Specific Improvements**:
```markdown
[在此详细描述改进内容]
[Describe improvements in detail here]
```

</details>

<details>
<summary>🆕 新提示词建议 | New Prompt Suggestion</summary>

| 属性 Attribute | 内容 Content | 说明 Description |
|----------------|--------------|-------------------|
| **提示词名称 \| Prompt Name** | `[名称]` | 简洁且描述性 \| Concise and descriptive |
| **适用场景 \| Use Cases** | `[场景描述]` | 具体的应用场景 \| Specific application scenarios |
| **目标用户 \| Target Users** | `[用户群体]` | 主要使用者 \| Primary users |
| **核心功能 \| Core Features** | `[功能列表]` | 主要能力 \| Main capabilities |
| **技术栈 \| Tech Stack** | `[相关技术]` | 涉及的技术 \| Related technologies |
| **难度等级 \| Difficulty** | `[初级/中级/高级]` | 使用难度 \| Usage difficulty |

**完整提示词草案 | Complete Prompt Draft**:
```markdown
[在此提供完整的提示词内容草案]
[Provide complete prompt content draft here]
```
...
<!-- 如果可能，提供一个使用示例或模拟场景 -->
<!-- If possible, provide usage examples or simulation scenarios -->

### 💼 场景演示 | Scenario Demonstration

<details>
<summary>📝 示例一：基础使用 | Example 1: Basic Usage</summary>

**用户输入 | User Input**:
```
[用户输入的示例内容]
[Example user input content]
```

**期望输出 | Expected Output**:
```
[期望的 AI 输出结果]
[Expected AI output results]
```
...
<details>
<summary>🚀 示例二：高级功能 | Example 2: Advanced Features</summary>

**用户输入 | User Input**:
```
[高级功能的输入示例]
[Advanced feature input example]
```

**期望输出 | Expected Output**:
```
[高级功能的输出示例]
[Advanced feature output example]
```
...
<!-- 表明你是否愿意参与实现这个功能 -->
<!-- Indicate whether you are willing to participate in implementing this feature -->
